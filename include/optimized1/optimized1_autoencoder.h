...
class Optimized1_Autoencoder {
  ...
  static constexpr dim3 _conv_block_size_1 = dim3(16, 16, 4);
  static constexpr dim3 _conv_block_size_2 = dim3(2, 2, 256);
  static constexpr dim3 _conv_block_size_3 = dim3(4, 2, 128);
...
public:
   ...
   */
  Optimized1_Autoencoder(const char *filename);
