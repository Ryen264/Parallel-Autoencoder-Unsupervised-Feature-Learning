 ...
 *
 */
class IAutoencoder { protected:
    // The first conv2d layer of the encoder
    static constexpr int _ENCODER_FILTER_1_DEPTH = 256;
    static constexpr int _ENCODER_FILTER_1_SIZE = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT * IMAGE_DEPTH * _ENCODER_FILTER_1_DEPTH;
    ...
    static constexpr int _ENCODER_FILTER_2_SIZE  = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT * _ENCODER_FILTER_1_DEPTH * _ENCODER_FILTER_2_DEPTH;
    ...
    static constexpr int _DECODER_FILTER_1_SIZE  = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT * _ENCODER_FILTER_2_DEPTH * _DECODER_FILTER_1_DEPTH;
    ...
    static constexpr int _DECODER_FILTER_2_SIZE  = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT * _DECODER_FILTER_1_DEPTH * _DECODER_FILTER_2_DEPTH;
    ...
    static constexpr int _DECODER_FILTER_3_SIZE  = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT * _DECODER_FILTER_2_DEPTH * _DECODER_FILTER_3_DEPTH;
  ...
  public:
     ...
     * @param checkpoint Save the model's parameter after a specific number of epochs (set to 0 to disable)
     * @param output_dir The file to save model's param
     */
    virtual void fit(const Dataset &dataset, int n_epoch, int batch_size, float learning_rate,
                    bool verbose, int checkpoint, const char *output_dir = "./model") = 0;
