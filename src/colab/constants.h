...
constexpr int ENCODER_FILTER_1_SIZE  = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT
                                     * IMAGE_DEPTH * ENCODER_FILTER_1_DEPTH;

// The second conv2d layer of the encoder
constexpr int ENCODER_FILTER_2_DEPTH = 128;
constexpr int ENCODER_FILTER_2_SIZE  = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT
...
constexpr int DECODER_FILTER_1_SIZE  = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT
...
constexpr int DECODER_FILTER_2_SIZE  = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT
...
constexpr int DECODER_FILTER_3_SIZE  = CONV_FILTER_WIDTH * CONV_FILTER_HEIGHT
