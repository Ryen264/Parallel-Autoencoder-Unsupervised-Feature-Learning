...
void Optimized1_Autoencoder::_forward_pass(
  ...
  optimized1_avg_pooling(_out_encoder_relu_1,
                         _out_avg_pooling_1,
                         n,
                         width,
                         height,
  ...
  // Dim: n * w/2 * w/2 * 256
  // Second conv2D layer
  optimized1_conv2D(_out_avg_pooling_1,
                    _encoder_filter_2,
  ...
  optimized1_avg_pooling(_out_encoder_relu_2,
                         _out_avg_pooling_2,
                         n,
                         width / 2,
                         height / 2,
  ...
  // First conv2D layer
  optimized1_conv2D(_out_avg_pooling_2,
                    _decoder_filter_1,
...
float Optimized1_Autoencoder::_fit_batch(
  ...
  optimized1_conv2D_grad(_out_avg_pooling_2,
                         d_out,
                         d_filter,
                         n,
                         width / 4,
  ...
  optimized1_avg_pooling_backward(
  ...
  optimized1_conv2D_grad(_out_avg_pooling_1,
                         d_out,
                         d_filter,
                         n,
                         width / 2,
